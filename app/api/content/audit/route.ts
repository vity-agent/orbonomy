...
export async function POST(request: NextRequest) {
  try {
    ...
    const messages = [
      { role: "system" as const, content: "You are a content quality auditor. Analyze content for clarity, engagement, SEO, readability, grammar. Return structured audit with scores." },
